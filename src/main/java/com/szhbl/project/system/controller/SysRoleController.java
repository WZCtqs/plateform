...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult list(SysRole role)
    {
     //   startPage();
        ...
        return AjaxResult.success(roleService.buildRoleTree(list));
    ...
    public AjaxResult treeselect(SysRole sysRole)
    {
        List<SysRole> sysRoles = roleService.selectRoleList(sysRole);
        return AjaxResult.success(roleService.buildRoleTreeSelect(sysRoles));
    }
