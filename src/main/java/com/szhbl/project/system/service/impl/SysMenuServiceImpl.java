...
import com.szhbl.framework.web.domain.TreeSelect;
import com.szhbl.project.system.domain.SysMenu;
import com.szhbl.project.system.domain.vo.MetaVo;
import com.szhbl.project.system.domain.vo.RouterVo;
import com.szhbl.project.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
     ...
     */
    @Override
    public List<SysMenu> selectMenuTreeByUserId(Long userId,String modelId)
    {
        List<SysMenu> menus = null;
        if (SecurityUtils.isAdmin(userId))
        {
            menus = menuMapper.selectMenuTreeAll(modelId);
        }
        else
        {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus)
    {
        ...
        for (SysMenu menu : menus)
        {
            ...
            router.setModelId(menu.getModelId());
