 ...
 * @date 2020-03-24
 */
public class BusiShippingorderGoods
{
    ...
    private String goodsbzS;

    /** 货物hs编码备注 */
    @Excel(name = "货物hs编码备注")
    private String hsbz;
    private String hsbzS;
    ...
    public void setGoodsbzS(String goodsbzS)
    {
        this.goodsbzS = goodsbzS;
    }
    public String getGoodsbzS()
    {
        return goodsbzS;
    }
    ...
    public void setHsbzS(String hsbzS)
    {
        this.hsbzS = hsbzS;
    }
    public String getHsbzS()
    {
        return hsbzS;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("hsbz", getHsbz())
            .append("goodsbzS", getGoodsbzS())
            .append("hsbzS", getHsbzS())
