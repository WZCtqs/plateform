...
import com.szhbl.common.core.text.Convert;
import com.szhbl.common.exception.CustomException;
import com.szhbl.common.utils.DateUtils;
import com.szhbl.common.utils.StringUtils;
import com.szhbl.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
     ...
     * 固定首行
     */
    public void createFreeFirst(){
        sheet.createFreezePane(0, 1); // 冻结x*2(宽*高)区域中的单元格，这里是冻结标题与表头单元格
    }
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column) {
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                cellStyle.setWrapText(attr.wrapText());
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SzhblConfig.getDownloadPath() + filename;
