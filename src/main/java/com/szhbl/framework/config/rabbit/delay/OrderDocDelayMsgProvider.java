...
@Component
public class OrderDocDelayMsgProvider {
     ...
     */
    public OrderDocDelayMsgProvider(RabbitTemplate rabbitTemplate){
    ...
    public void sendMessage(MessagePojo messagePojo) throws Exception {
        if(messagePojo != null){
            ...
            rabbitTemplate.convertAndSend(OrderDocDelayContent.DOC_ORDER_TTL_EXCHANGE, OrderDocDelayContent.DOC_ORDER_TTL_ROUTINGKEY,messagePojo, message -> {
                //设置延时超时时间
